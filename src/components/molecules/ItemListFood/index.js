...
const ItemListFood = ({image}) => {
  return (
    <View style={{ flexDirection: 'row', backgroundColor: 'white', paddingHorizontal: 24, paddingVertical: 8, alignItems: 'center' }}>
        ...
        <View style={{ flex: 1 }}>
            <Text style={{  fontFamily: 'Poppins-Regular', fontSize: 16, color: '#020202' }}>Soup Bumil</Text>
            <Text style={{ fontFamily: 'Poppins-Regular', fontSize: 13, color: '#8D92A3' }}>IDR 289.000</Text>
        </View>
        <Rating/>
    </View>
  )
